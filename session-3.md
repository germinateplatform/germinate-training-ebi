...
# Session 3: Phenotypic Data (Continued) and Genotypic Data

# Part 1 - Phenotypic data
...
This tutorial will show you how to explore, visualize and export phenotypic trials data. It builds on the previous session on using groups with phenotypic data. We can access traits by clicking on the **Traits** option in the left hand side menu in Germinate. **Traits** is found under **Data** -> **Trials Data**.
...
The **Time series** option gives you tools to explore when data was collected. Try clicking on this and looking at the tools it provides.
...
1. <details><summary>Looking at the traits page, how many traits are in this Germinate database?</summary>Answer: There are 56 traits defined in the database.</details>
...
4. <details><summary>Navigate to the trials export page and select the first dataset (it has an id of 4). Using the overview statistics, which plant line has the lowest value for the trait '1000 spine weight' across the dataset?</summary>Answer: To get this we can select the trait '1000 Spine Weight [Kg]' now hover over the box plot to see which has the lowest value. You may need to use the chart tools to zoom into an area. The answer is 'CACTUAR-84' with a value of '23.535'.</details>
<br/>

# Part 2 - Genotypic Data
...
## Now are are ready to learn about <a href="session-4.html">'Session 4: Geographic Data and Searching'</a>
